...
const VideoInfo = ({ info }) => {
  return (
    <div className="pt-[20%] pl-20 mr-auto absolute text-white bg-gradient-to-r from-black w-screen aspect-video">
      <h1 className="text-6xl font-bold w-1/3">{info.original_title}</h1>
